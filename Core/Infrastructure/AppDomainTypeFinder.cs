...
{
    /// <summary>
    /// A class that finds types needed by GovTown by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>
		/// Gets or sets wether GovTown should iterate assemblies in the app domain when loading GovTown types. Loading patterns are applied when loading these assemblies.
		/// </summary>
		...
		/// </summary>
        /// <remarks>
		/// If you change this so that GovTown assemblies aren't investigated (e.g. by not including something like "^GovTown|..." you may break core functionality.
		/// </remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the GovTown factory.</returns>
        ...
        private void AddAssembliesInAppDomain(HashSet<string> addedAssemblyNames, List<Assembly> assemblies)
        {
            ...
            {
                //if (assembly.FullName.Contains("Nop.Plugin.Payments.AliPay"))
                //{
                //    int i = 0;
                //}
                //if (assembly.FullName.Contains("GovTown.PayPal"))
                //{
                //    int j = 0;
                //}
        ...
        protected virtual void AddCustomAssemblies(HashSet<string> addedAssemblyNames, List<Assembly> assemblies)
        {
            ...
            {
                //if (assemblyName.Contains("Nop.Plugin.Payments.AliPay"))
                //{
                //    int i = 0;
                //}
        ...
        /// <returns>True if the assembly should be loaded into GovTown.</returns>
        public virtual bool Matches(string assemblyFullName)
        {
            //if (_assemblyMatchTable.ContainsKey("Nop.Plugin.Payments.AliPay"))
            //{
            //    int i = 0;
            //}
