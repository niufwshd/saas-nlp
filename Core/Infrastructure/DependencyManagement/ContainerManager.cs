...
using GovTown.Core.Caching;

namespace GovTown.Core.Infrastructure.DependencyManagement
{
    public class ContainerManager
    {
		...
		public bool TryResolve<T>(ILifetimeScope scope, out T instance)  where T : class
		{
