...
{
    /// <summary>
    /// Provides access to the singleton instance of the GovTown engine.
    /// </summary>
    public class EngineContext
    {
        #region Initialization Methods

        /// <summary>Initializes a static instance of the GovTown factory.</summary>
   ...
   //             if (!typeof(IEngine).IsAssignableFrom(engineType))
			//		throw new ConfigurationErrorsException("The type '" + engineType + "' doesn't implement 'GovTown.Core.Infrastructure.IEngine' and cannot be configured in /configuration/appSettings/add[@key=sm:EngineType] for that purpose.");
   //             return Activator.CreateInstance(engineType) as IEngine;
   //         }

   //         return new GovTownEngine();
   //     }

        #endregion

        /// <summary>Gets the singleton GovTown engine used to access GovTown services.</summary>
