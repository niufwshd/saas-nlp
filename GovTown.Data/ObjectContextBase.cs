...
namespace GovTown.Data
{
    ...
    public abstract class ObjectContextBase : DbContext, IDbContext
    {
		...
		//						{
		//							Entity = x.Entity,
		//							PreSaveState = (GovTown.Core.Data.EntityState)((int)x.State)
		//						})
		//						.ToArray();
  ...
  //      #endregion
		...
		public int ExecuteSqlThroughSmo(string sql)
		{
			...
			try
			{
                bool isSqlServer = true;/*DataSettings.Current.IsSqlServer;*/
		...
		public static string GetConnectionString()
		{
            ...
            //comment by nfw
            // return ConfigurationManager.ConnectionStrings["GovTown"].ToString();
